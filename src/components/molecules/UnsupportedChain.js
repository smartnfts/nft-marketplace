...
export default function UnsupportedChain () {
  ...
  const renderProviderText = () => {
    ...
    const providerTextList = {
      Metamask: 'Add/Change to Energi Testnet on Metamask',
      imToken: 'Add/Change to Energi Testnet on imToken',
      Wallet: 'Add/Change to Energi Testnet on Wallet'
    }
  ...
  return (
    ...
    >
      <Button
        variant='outlined'
        color='primary'
        onClick={ () => addNetwork(chains.energiTestnet, account) }
        sx={{
          maxWidth: 600,
          margin: 'auto',
          display: 'flex',
